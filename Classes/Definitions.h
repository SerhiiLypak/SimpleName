...
#define PIPE_GAP 10
#define MINUS_PIPE_GAP 50
#define UPPER_SCREEN_PIPE_THRESHOLD 0.65
#define LOWER_SCREEN_PIPE_THRESHOLD 0.35

#define PIPE_MOVEMENT_SPEED 0.01

#define BIRD_COLLISION_BITMASK 1
#define OBSTACLE_COLLISION_BITMASK 2
#define POINT_COLLISION_BITMASK 3
#define MINUS_POINT_COLLISION_BITMASK 4
